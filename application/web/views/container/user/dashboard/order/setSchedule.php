...
<section class="content">
    ...
    <div class="row">
        <?php
        $sql = $sql = "SELECT * FROM `orders` WHERE uid='{$_SESSION["uid"]}' AND order_id='{$_REQUEST["v"]}'";
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3 col-xl-3">
                        ...
                        <p><b>Payment ID : </b><?= $orderRow["payment_id"] ?></p>
                    </div>
                    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3 col-xl-3">
                                            ...
                                            <tr id="<?= $schRow["status"] ?>">
                                                ...
                                                <td>
                                                    ...
                                                    switch ($schRow["status"]) {
                                                        case "schedule":
                                                            echo "<button class=\"btn btn-primary btn-xs \" data-toggle=\"modal\" data-target=\"#myModal\" onclick=\"updateSchedule('{$schRow["id"]}')\" title=\"Set new schedule\"><span class=\"glyphicon glyphicon-time\"></span> New schedule</button></td>";
                                                            break;
                                                    }
                                                    ?>
                                                ...
                                                <td><button class="btn btn-warning btn-xs" title="Star Reating" data-toggle="modal" data-target="#myRating" onclick="setReating('<?= $schRow["id"] ?>', '<?= $schRow["rating"] ?>', '<?= $schRow["feedback"] ?>')"><span class="glyphicon glyphicon-flag"></span> Review</button></td>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form method="post" id="change_schedule">
                                ...
                                <input type="hidden" name="modify" id="modify" value="<?= $_SESSION["uid"] ?>">
                                <input type="hidden" name="action" id="action" value="changeSchedule">
                                <div class="form-gorup">
                                    <button type="submit" id="change-btn" class="btn btn-primary" >Save</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-body">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form method="post" id="feedbacksubmit">
                                <div class="form-gorup">
                                    <div class="feedback">
                                        <div class="rating">
                                ...
                                <div class="form-gorup">
                                    <label for="datetime">Feedback</label>
...
<script>
    $(function () {
        ...
        $('#feedbacksubmit').validate({// initialize the plugin
            rules: {
                ...
                $.ajax({
                    ...
                    xhr: function () {
                        ...
                        xhr.upload.addEventListener('progress', function (e) {
                            var progressbar = Math.round((e.loaded / e.total) * 100);
                            //$("#inner-progress").css('width', progressbar + '%');
                            $("#feed-btn").html("Please Wait... " + progressbar + '%');
                        });
                        return xhr;
                    },
                    success: function (objString) {
