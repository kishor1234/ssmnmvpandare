...
<html>
    ...
    <body>
        <section>
            <div class="container">
                <div class="user signinBx">
                    <div class="imgBx"><img src="/assets/images/user/image1.jpeg" alt="" /></div>
                    <div class="formBx">
                        <form action="" id="myResetForm" onsubmit="return false;">
                            ...
                            <input type="submit" id="reset-btn" name="" value="Reset" />
                            <p class="signup">
        ...
        <script>
            $(function () {
                $('#myResetForm').validate({// initialize the plugin
                    rules: {
                        ...
                        $.ajax({
                            ...
                            xhr: function () {
                                ...
                                xhr.upload.addEventListener('progress', function (e) {
                                    ...
                                    $("#reset-btn").html("Please Wait... " + progressbar + '%');
                                });
                                return xhr;
                            },
