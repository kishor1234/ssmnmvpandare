        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-tabs">
                    <?php
                    $rtitle = str_replace('%20', ' ', $_REQUEST["v"]);
                    $idtitle = str_replace('%20', '-', $_REQUEST["v"]);
                    $sql = $main->select("post", $_SESSION["db_1"]) . $main->where(array("category" => "Booking", "title" => $rtitle), "AND");
                        ...
                        <form action="javascript:void(0)" class="form-horizontal" id="myBookingForm" name="myBookingForm" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control" readonly name="product"  id="product">
                                        <option value='<?= $rtitle ?>' data-toggle='#<?= $idtitle ?>'><?= $rtitle ?></option>
                                    </select>
                                </div>
