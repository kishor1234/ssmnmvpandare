                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown tasks-menu">
                                ...
                                <a href="/cart" class="dropdown-toggle" >
                                    ...
                                    <span class="label label-danger" id="ct">0</span>
                                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?= $_SESSION["fname"] . ' ' . $_SESSION["lname"] ?></span>
                                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li ><a href="/"><i class="fa fa-magnet"></i> <span>Main Site</span></a></li>
                        <!--<li><a href="/dashboard"><i class="fa fa-dashboard"></i> Project</a></li>-->
