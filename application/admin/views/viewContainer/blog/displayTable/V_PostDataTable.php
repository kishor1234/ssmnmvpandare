    ...
    ?>
                    ...
                    ?></td>
                            ...
                            <td>
                                ...
                                <a href="#" onclick=" return deletepostURL('<?php echo $obj->encdata("C_DeleteCompletePost") . "&v=" . $obj->encdata("V_PostDataTable"); ?>', '#display', '<?php echo $row["id"]; ?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
    <?php
}
