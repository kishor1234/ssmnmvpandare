            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form action="#" id="uploadFormd" name="frmuploads" onsubmit="return uploadEvent('<?php echo $obj->encdata("C_UploadTestimonials"); ?>', '#progressid', '#uploadFormd')" method="post" enctype="multipart/form-data">
                            <div class="col-lg-12">
                                <label>Name</label>
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea name="testimonials" id="testimonials" class="form-control" required=""></textarea>
                            </div>
                            <div class="col-lg-12">
                                <label>Logo</label>
                            ...
                            <div class="col-lg-12"><br><br>
                                <input id="submitButton" class="btn btn-primary" type="submit" name='btnSubmit' value="Upload Testimonials" />
                            </div>
                        </form>
                        <center>
                            <br><br>
        ...
        <div class="form-group" id='adp'>
            <div class="col-lg-12" style="overflow: auto;">
                <table id="example" class="table table-hover  table-responsive table-bordered table-striped">
                    ...
                    <?php
                    $sql = $main->select("testimonials", $_SESSION["db_1"]) . $main->orderBy("DESC", "id") . $main->limitWithOffset($offset, $limit);
                    $result = $main->adminDB[$_SESSION["db_1"]]->query($sql);
                    $i = 0;
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr id="#trsk<?php echo $row["id"]; ?>">
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" onclick="return deleteLogo('<?php echo $obj->encdata("C_DeleteTestimonials") . "&logo=" . $obj->encdata($row["logopath"]); ?>', '#msg', '<?php echo $row["id"]; ?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a></td>
                        </tr>
                        <?php
                    }
                    ?>
