...
$auth_users = array(
    'admin' => '$2y$10$WoJdfuuwBMU8n5DwSFqxH.XsJTVodj1aZEMqOCs7zzKT.Vy.xS3VS', //admin@123
    'user' => '$2y$10$.EHwh3p1YHKZmY2JC4D6BetKQZgh9mZGyjlsRsI9vczIRlJkTSIUi' //12345
);
...
// update root path
if ($smt && isset($_SESSION[FM_SESSION_ID]['logged'])) {
...
define('FM_READONLY', $smt && !empty($readonly_users) && isset($_SESSION[FM_SESSION_ID]['logged']) && in_array($_SESSION[FM_SESSION_ID]['logged'], $readonly_users));
...
unset($p, $smt, $iconv_input_encoding, $use_highlightjs, $highlightjs_style);
